<?php
class ci_aranceles_categorias extends gnosis_ci
{
    //-------------------------------------------------------------------------
    function relacion()
    {
    ...
    {
        $datos = toba::consulta_php('co_parametros')->get_aranceles_categorias();
    ...
    function conf__form(gnosis_ei_formulario $form)
    {
        if ($this->relacion()->esta_cargada()) {
            $datos = $this->tabla('evt_aranceles_categorias')->get();            
    ...
    {
        $this->tabla('evt_aranceles_categorias')->set($datos);
