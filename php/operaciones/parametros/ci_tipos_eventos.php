<?php
class ci_tipos_eventos extends gnosis_ci
{
    //-------------------------------------------------------------------------
    function relacion()
    {
    ...
    {
        $datos = toba::consulta_php('co_parametros')->get_tipos_eventos();
    ...
    function conf__form(gnosis_ei_formulario $form)
    {
        if ($this->relacion()->esta_cargada()) {
            $datos = $this->tabla('evt_tipos')->get();            
    ...
    {
        $this->tabla('evt_tipos')->set($datos);
