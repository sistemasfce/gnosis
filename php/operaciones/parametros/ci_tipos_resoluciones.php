<?php
class ci_tipos_resoluciones extends gnosis_ci
{
    //-------------------------------------------------------------------------
    function relacion()
    {
    ...
    {
        $datos = toba::consulta_php('co_parametros')->get_resoluciones_tipos();
    ...
    function conf__form(gnosis_ei_formulario $form)
    {
        if ($this->relacion()->esta_cargada()) {
            $datos = $this->tabla('evt_resoluciones_tipos')->get();            
    ...
    {
        $this->tabla('evt_resoluciones_tipos')->set($datos);
