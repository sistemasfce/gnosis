<?php
class ci_estados_inscripciones extends gnosis_ci
{
    //-------------------------------------------------------------------------
    function relacion()
    {
    ...
    {
        $datos = toba::consulta_php('co_parametros')->get_estados_inscripciones();
    ...
    function conf__form(gnosis_ei_formulario $form)
    {
        if ($this->relacion()->esta_cargada()) {
            $datos = $this->tabla('ins_estados')->get();            
    ...
    {
        $this->tabla('ins_estados')->set($datos);
