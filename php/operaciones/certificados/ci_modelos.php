...
class ci_modelos extends gnosis_ci
{
   //-------------------------------------------------------------------------
    function relacion()
    {
    ...
    {
        $datos = toba::consulta_php('co_certificados')->get_certificados();
    ...
    function conf__form(gnosis_ei_formulario $form)
    {
        if ($this->relacion()->esta_cargada()) {
            $datos = $this->tabla('evt_certificados')->get();            
    ...
    {
        $this->tabla('evt_certificados')->set($datos);
